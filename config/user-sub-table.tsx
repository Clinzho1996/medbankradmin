...
export function UserSubscriptionDataTable<TData, TValue>({
	columns,
	data,
	...
	const filterDataByDateRange = () => {
		...
		const filteredData = data.filter((readers: any) => {
			const dateJoined = new Date(readers.start_date);
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<div className="p-3 flex flex-row rounded-lg justify-between border-b-[1px] border-[#E2E4E9] bg-white items-center gap-10 max-w-full">
